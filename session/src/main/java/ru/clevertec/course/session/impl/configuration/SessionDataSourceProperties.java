package ru.clevertec.course.session.impl.configuration;
...
@ConfigurationProperties(prefix = "clevertec.session.datasource")
public class SessionDataSourceProperties implements BeanClassLoaderAware, InitializingBean {
    ...
    public String determineDriverClassName() {
        ...
        if (!StringUtils.hasText(driverClassName)) {
            throw new SessionDataSourceProperties.DataSourceBeanCreationException("Failed to determine a suitable driver class", this,
    ...
    public String determineUrl() {
        ...
        if (!StringUtils.hasText(url)) {
            throw new SessionDataSourceProperties.DataSourceBeanCreationException("Failed to determine suitable jdbc url", this,
                    this.embeddedDatabaseConnection);
        }
        return url;
    }
    ...
    static class DataSourceBeanCreationException extends BeanCreationException {
        ...
        private final SessionDataSourceProperties properties;

        private final EmbeddedDatabaseConnection connection;

        DataSourceBeanCreationException(String message, SessionDataSourceProperties properties,
        ...
        SessionDataSourceProperties getProperties() {
            return this.properties;
        }
